...
public class BizLog {
	...
	public void jointText(String allAddressString) {
		if (this.operationType == LogTypeEnum.addAddress.getValue()) {
			...
			this.logText = ("新增规则：" + this.ruleExpression) == null ? "" : this.ruleExpression + "(id=" + this.deliveryStationRuleId + "),站点：" + this.originStationName + "(id=" + this.originStationId + "),关键词：" + this.addressName + "(id=" + this.addressId + ")";
		} else if (this.operationType == LogTypeEnum.deleteRule.getValue()) {
			this.logText = ("删除规则：" + this.ruleExpression) == null ? "" : this.ruleExpression + "(id=" + this.deliveryStationRuleId + "),站点：" + this.originStationName + "(id=" + this.originStationId + "),关键词：" + this.addressName + "(id=" + this.addressId + ")";

 ...
 * “粗”地址：拆分后，没有审核确认的地址
 *
 * @author songkaojun 2015年4月2日
 */
@Entity
@Table(name = "RAW_ADDRESS")
public class RawAddress {
	...
	// "address")
	// private Set<DeliveryStationRule> deliveryStationRules = new
	// HashSet<DeliveryStationRule>();
	//
	// @OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy =
	// "address")
	...
	public RawAddress(Long id, String name, Integer addressLevel, Long parentId, String path) {
		super();
		this.id = id;
		this.name = name;
	...
	// }
	//
	// public void setDeliveryStationRules(Set<DeliveryStationRule>
	// deliveryStationRules) {

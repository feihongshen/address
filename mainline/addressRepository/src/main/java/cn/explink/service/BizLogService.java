...
public class BizLogService {
    ...
    /**
     * @Title: loggerInfo @description 打印日志并收集保存日志的方法 @author 刘武强 @date 2015年11月27日上午9:54:03 @param @param
     * clazz @param @param bizLogList @param @param bizLogDAO @param @param bizLogService @return void @throws
     */
    ...
    /**
     * @Title: save @description TODO @author 刘武强 @date 2015年11月26日下午6:31:47 @param @param bizLog @return void @throws
     */
    ...
    /**
     * @Title: findInfo @description 根据查询日志页面上传过来的条件，查询日志信息 @author 刘武强 @date 2015年11月25日上午11:14:47 @param @param
     * operationType @param @param beginTime @param @param endTime @param @param operationIP @param @param
     * page @param @param pageNumber @param @return @return Map<String,Object> @throws
     */
    @SuppressWarnings("unchecked")
    public Map<String, Object> findInfo(int operationType, String beginTime, String endTime, String operationIP,
            int page, int pageNumber, Long customerId) {
        Map<String, Object> map = this.bizLogDAO.findInfo(operationType, beginTime, endTime, operationIP, page,
                pageNumber, customerId);
        // 拼接日志内容
            ...
            if (temp.getOperationType() == LogTypeEnum.changeStationRelation.getValue()) {
                ...
                if (temp.getSplitCombineAddress() != null) {
                    for (String addressId : temp.getSplitCombineAddress().split(",")) {
                        if ((StringUtils.isNotEmpty(addressId)) && BizLogService.isNumeric(addressId)) {
    ...
    /**
     * @Title: isNumeric @description 用正则表达式判断字符串是否由数字组成 @author 刘武强 @date 2015年11月26日上午11:25:04 @param @param

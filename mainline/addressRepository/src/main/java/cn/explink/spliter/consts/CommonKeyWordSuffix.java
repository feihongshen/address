...
public class CommonKeyWordSuffix {
	private static final String[] keywords = new String[] { "省", "自治区", "市", "区", "县", "街道", "街", "大道", "路", "小区", "校区", "幼儿园", "小学", "中学", "附中", "大学", "学院", "大学城", "新城", "科学城", "工业城", "皮具城", "纺织城",
			...
			"银行", "机场", "超市", "农场", "研究院", "居", "轩", "苑", "湾", "画廊", "公馆", "广场", "中心", "宿舍", "公安局", "税务局", "工商局", "分局", "总局", "里" };

	public static Set<String> getKeywordSuffixSet() {
		return new LinkedHashSet<String>(Arrays.asList(CommonKeyWordSuffix.keywords));
	}
}

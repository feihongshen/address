...
function goDetailPage(title, addurl,width,height){
	var mainUrl=window.location.pathname;
	var index=mainUrl.lastIndexOf("/");
	addurl=mainUrl.substring(0,index)+"/"+addurl;
	window.location=addurl;
}
function goDetailPageByCondition(title, addurl,gname){
	var mainUrl=window.location.pathname;
	var index=mainUrl.lastIndexOf("/");
	addurl=mainUrl.substring(0,index)+"/"+addurl;
	window.location=addurl;
...
function ExcelExport(url,datagridId){
	...
	var temp= url+ encodeURI(fields+params);

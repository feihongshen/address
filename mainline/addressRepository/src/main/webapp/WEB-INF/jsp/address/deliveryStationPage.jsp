	...
	<div class="easyui-layout" style="height: 540px;">
		<div data-options="region:'west',split:true" title="条件搜索" style="width: 500px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="10">
				<tr>
					<td align="left"><select id="searchType"><option value="1">关键字</option>
							<option value="2">站点</option></select></td>
				...
				<table id="stationRule" class="table table-bordered">
					...
					<tbody>
						<tr id="stationRuleOpe">
							<td colspan="3" align="left"><a href="javascript:void(0)" class="easyui-linkbutton"
								onclick="submitRules()">保存</a> <a href="javascript:void(0)" class="easyui-linkbutton"
								onclick="addRule()" id="addRule">新增</a></td>
						</tr>
					</tbody>
				</table>
			</div>
			<div class="easyui-panel" title="设置时效-" id="relCust"
				style="padding: -1px; margin-bottom: 10px; min-height: 180px; width: auto">
				<table class="table table-bordered" id="vendorAge" style="width: auto; height: auto;">
					...
					<tbody>
						<tr id="ageOpe">
							<td colspan="3" align="left"><a href="javascript:void(0)" class="easyui-linkbutton"
								onclick="submitVendorAge()">保存</a> <a href="javascript:void(0)" class="easyui-linkbutton"
								onclick="addAge()" id="addAge">新增</a></td>
						</tr>
					</tbody>
				</table>
			</div>

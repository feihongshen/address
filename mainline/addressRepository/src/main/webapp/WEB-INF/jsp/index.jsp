...
<body class="easyui-layout">
	...
	<div data-options="region:'west',split:true,title:'功能菜单'"
		...
		<ul class="easyui-tree">
			...
			<li><span>数据维护</span>
				<ul>
					<li><a href="#" onclick="addTab('关键词导入','dizhiku/gjcdr.html')">关键词导入</a></li>
			...
			<li><span>关联设置</span>
				<ul>
					...
					<li><a href="#"
						onclick="addTab('配送站点关联维护','dizhiku/pszdglwh.html')">配送站点关联维护</a></li>
					<li><a href="#"
						onclick="addTab('配送员关联维护','dizhiku/psyglwh.html')">配送员关联维护</a></li>
				</ul></li>
			<li><span>数据统计</span>
				<ul>
					<li><a href="#"
						onclick="addTab('站点匹配查询','dizhiku/zdppcx.html')">站点匹配查询</a></li>
					<li><a href="#"
						onclick="addTab('站点匹配率查询','dizhiku/zdpplcx.html')">站点匹配率查询</a></li>
				</ul></li>
			<li><span>系统设置</span>
				<ul>
					<li><a href="#"
						onclick="addTab('库户账号管理','dizhiku/khzhgl.html')">库户账号管理</a></li>
				</ul></li>
		</ul>
	</div>
	<div data-options="region:'south',border:false"
		style="height: 30px; background: #A9FACD; padding: 10px;">Copyright
		? 2008-2014 Lefeng.com All Rights Reserved.</div>
	...
	<div id="dlg" class="easyui-dialog"
		style="width: 450px; height: 405px; padding: 10px 20px" closed="true"
		buttons="#dlg-buttons">
		...
		<form id="fm" method="post" novalidate>
			...
			<div class="fitem">
				<label>登陆帐号:</label> <input name="uid" class="easyui-validatebox"
					required="true" />
			</div>
			<div class="fitem">
			...
			<div class="fitem">
				<label>确认密码:</label> <input type="password" id="cfmpass"
					name="cfmpass" />
			</div>
			<div class="fitem">
			...
			<div class="fitem">
				<label>部门:</label> <input name="department"
					class="easyui-validatebox" required="true" size="32" />
			</div>
			<div class="fitem">
				<label>手机:</label> <input name="mobile" class="easyui-validatebox"
	...
	<div id="dlg-buttons">
		<a href="javascript:void(0)" class="easyui-linkbutton"
			iconCls="icon-ok" onclick="saveAdmin()">保存</a> <a
			href="javascript:void(0)" class="easyui-linkbutton"
			iconCls="icon-cancel" onclick="javascript:$('#dlg').dialog('close')">取消</a>
	</div>
	<div id="dlgChng" class="easyui-dialog"
		style="width: 360px; height: 220px; padding: 10px 20px" closed="true"
		buttons="#dlgChng-buttons">
		<div class="ftitle">修改密码</div>
		<form id="fmChng" method="post" novalidate>
			<div class="fitem">
				<label>原始密码:</label> <input type="password" id="oldpass"
					name="oldpass" class="easyui-validatebox" required="true" />
			</div>
			<div class="fitem">
				<label>登录密码:</label> <input type="password" id="password"
					name="pass" class="easyui-validatebox" required="true" />
			</div>
			<div class="fitem">
				<label>确认密码:</label> <input type="password" id="cfmpass"
					name="cfmpass" class="easyui-validatebox" required="true" />
			</div>
		</form>
	</div>
	<div id="dlgChng-buttons">
		<a href="javascript:void(0)" class="easyui-linkbutton"
			iconCls="icon-ok" onclick="chngPass()">保存</a> <a
			href="javascript:void(0)" class="easyui-linkbutton"
			iconCls="icon-cancel"
